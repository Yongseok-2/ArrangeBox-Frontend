...
const HowItWorksPage = () => {
    ...
    return (
        <div className="min-h-screen bg-neutral-50/50 pt-16 pb-32">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="mb-8 flex justify-start">
                    <button
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center gap-2 text-neutral-500 hover:text-neutral-900 transition-colors font-bold px-4 py-2 bg-white rounded-full shadow-sm border border-neutral-200/50 hover:shadow-md"
                    >
                ...
                <div className="mb-16 text-center">
                    <h1 className="text-4xl md:text-5xl font-black text-neutral-900 tracking-tight mb-4" style={{ fontWeight: 700 }}>
